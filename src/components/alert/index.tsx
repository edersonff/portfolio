...
export default function Alert({ message, status }: AlertType) {
  ...
  if (isSucess) {
    AlertComponent = (
      ...
      >
        <div>
          <h3 className="text-lg small:text-base font-bold">Success!</h3>
  ...
  if (isWarning) {
    AlertComponent = (
      ...
      >
        <div>
          <h3 className="text-lg small:text-base font-bold">Warning!</h3>
  ...
  if (isError) {
    AlertComponent = (
      ...
      >
        <div>
          <h3 className="text-lg small:text-base font-bold">Error!</h3>
          <p className="text-sm">{message}</p>
        </div>
      </AlertContainer>
    );
  ...
  if (isInfo) {
    AlertComponent = (
      ...
      >
        <div>
          <h3 className="text-lg small:text-base font-bold">Info!</h3>
          <p className="text-sm">{message}</p>
        </div>
      </AlertContainer>
    );
